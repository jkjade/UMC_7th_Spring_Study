...
public class MemberRestController {
    ...
    public ApiResponse<MemberResponseDTO.MissionPreViewListDTO> getMissionList(@ExistStore @PathVariable(name = "memberId") Long memberId, @RequestParam(name = "page") Integer page){
